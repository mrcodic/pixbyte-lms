    ...
    <div class="wrapper-page-light f-height">
            ...
            <div class="uk-container uk-container-expand rm-expand">
                ...
                <div class="uk-flex uk-flex-middle uk-margin-small-left" uk-grid>
                    ...
                    <div class="page-header uk-margin-medium-top uk-margin-medium-bottom breadcrumb uk-width-3-4">
                        <h3 class="uk-margin-remove-bottom title-add">Add New Question Bank</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="uk-container uk-container-expand rm-expand uk-margin-medium-top uk-margin-left">
            <div class="add-classroom">
                <form action="{{ route('question-bank.store') }}" method="POST" id="target" enctype="multipart/form-data" class="room-form">
                    @csrf
                    <fieldset class="uk-fieldset add-new" uk-grid>
                        <x-input id="questions" class="uk-width-1-1" type="text" name="questions"  hidden/>
                        <div class="uk-margin uk-width-1-1">
                            <input class="uk-input title @error('name')error-border @enderror" name="name" type="text" placeholder="Question bank title goes here....." autofocus>
                            @error('name')
...
{{--                            </div>--}}
                        ...
                        <div class="uk-margin uk-width-1-5" id="dynamic">
