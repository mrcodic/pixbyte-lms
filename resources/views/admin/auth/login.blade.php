...
<div class="auth-wrapper auth-cover">
  <div class="auth-inner row m-0">
    ...
    <a class="brand-logo" href="#">
     {{-- <img src="{{asset('img/LOGO.svg')}}" width="60" height="60"> --}}
{{--      <h2 class="brand-text text-primary ms-1">Mives</h2>--}}
    </a>
    <!-- /Brand logo-->
    ...
    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
      <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
        @if($configData['theme'] === 'dark')
          <img class="img-fluid" src="{{asset('admin/images/pages/login-v2-dark.svg')}}" alt="Login V2" />
          @else
          <img class="img-fluid" src="{{asset('admin/images/pages/login-v2.svg')}}" alt="Login V2" />
        @endif
      </div>
    </div>
    <!-- /Left Text-->
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        <div class="text-center mx-auto">
            <img src="{{asset('img/LOGO_dark.svg')}}" width="150" height="150">
        </div>
        <h2 class="card-title fw-bold mb-1">Welcome to Mives! 👋</h2>
        <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

        <!-- Validation Errors -->
        @if ($errors->any())
            <div class=" px-2 py-1 rounded alert alert-danger alert-dismissible fade show ">
        ...
        <form class="auth-login-form mt-2" action="{{route('adminLogin')}}" method="POST">
         @csrf
            <div class="mb-1">
