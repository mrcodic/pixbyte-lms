...
{{--    </li>--}}
      ...
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <span class="avatar">
          <img class="round"
            src="{{ Auth::guard('admin')->user() ? asset('admin/images/portrait/small/avatar-s-11.jpg') : asset('admin/images/portrait/small/avatar-s-11.jpg') }}"
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
        ...
        <a class="dropdown-item" href="/admin/point/settings">
