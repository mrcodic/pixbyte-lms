    ...
    <div class="row">
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="invoice-repeater" id="questionForm" action="{{route('admin.question.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3 editor_cont">
                            ...
                            <div class="form-check form-check-secondary form-switch inline-flex mb-1">
                                <input type="checkbox" class="form-check-input editor_check" id="qtitle_check">
                            ...
                            <div class="editor_div">
                                ...
                                <input
                                    type="text"
                                    id="qtitle"
                                    class="form-control editor_input"
                                    placeholder="title"
                                    name="title"
                                    value=""
                                />
                                ...
                                <div data-repeater-item >
                                    <div class="row d-flex align-items-end">
                                        <div class="row editor_cont">
                                            <label class="form-label" for=""><h5> Answer - <span class='editor_index'>1</span></h5></label>

                                            <div class="form-check form-check-secondary form-switch inline-flex mb-1 mx-1 col-6">
                                                <input type="checkbox" class="form-check-input editor_check">
                                            ...
                                            <div class="form-check form-check-success inline-flex mb-1 mx-1 col-auto ms-auto">
                                                <input type="checkbox" class="form-check-input editor_currect_answer" >
                                            ...
                                            <div class="col-10 editor_div">
                                                ...
                                                <input
                                                    type="text"
                                                    class="form-control editor_input editor_input_answer"
                                                    placeholder="Answer"
                                                    value=""
                                                />
                                            </div>
    ...
    <script>
        ...
        ckeditor.forEach((inputEditor) => {
            ClassicEditor.create( inputEditor ,{
                ...
                ckfinder: {
                    ...
                    inputEditor.closest('.editor_cont').find('.editor_id').val(editor.id);
                    editors.push(editor);
                } )
        });
        ...
        $('#submitForm').click(function (e){
            ...
            $('[data-repeater-item]').each(function(index) {
                ...
                $('#answersFinal').append('<input name="answers['+index+'][id]" value="'+id+'">')
                $('#answersFinal').append('<input name="answers['+index+'][valueInput]" value="'+valueInput+'">')
                $('#answersFinal').append('<textarea name="answers['+index+'][valueCk]">'+valueCk+'</textarea>')
                $('#answersFinal').append('<input name="answers['+index+'][correct]" value="'+correct+'">')
                $('#answersFinal').append('<input name="answers['+index+'][status]" value="'+status+'">')
