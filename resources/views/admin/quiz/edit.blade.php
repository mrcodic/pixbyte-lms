    ...
    <div class="row">
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="quizForm" action="{{route('admin.quiz.update', $quiz)}}" method="POST">
                        @csrf
                            ...
                            <div class="col-3">
                                ...
                                <select name="user_id" id="user_id" class="form-select" required>
                                    ...
                                    @foreach ( $instructors as $instructor )
                                        <option value="{{$instructor->id}}" {{$quiz->user_id ==  $instructor->id? "selected" :null}}>{{ $instructor->name }}</option>
                                    @endforeach
                                </select>
                                @error('user_id')
                                    <div class="text-danger">{{$message}}</div>
                        ...
                        <div class="row">
                            <div class="mb-1 col-3">
                                ...
                                <select name="type" id="type" class="form-select" required>
                                    ...
                                    <option value="1" {{$quiz->type ==  1? "selected" :null}}>quiz in room</option>
                                    <option value="2" {{$quiz->type ==  2? "selected" :null}}>Exam in classroom</option>
                                    <option value="3" {{$quiz->type ==  3? "selected" :null}}>Assignment in room</option>
                                </select>
                                @error('type')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            ...
                            <div class="mb-1 col-3">
                                ...
                                <select name="grade" id="grade" class="form-select" required>
                                    ...
                                    @foreach ( $grades as $grade )
                                        <option value="{{$grade->id}}" {{$quiz->grade ==  $grade->id? "selected" :null}}>{{ $grade->name }}</option>
                                    @endforeach
                                </select>
                                @error('grade')
                                    <div class="text-danger">{{$message}}</div>
                            ...
                            <div class="mb-1 col-3 classroom" style="{{$quiz->classroom_id ?? 'display:none'}}">
                                <label class="form-label" for="classroom_id">Classroom</label>
                                <select name="classroom_id" id="classroom_id" class="form-select" >
                                    <option value="{{$quiz->classroom_id}}" selected>{{ $quiz->classroom_id ?$quiz->classroom->title :null}}</option>
                                </select>
                                @error('classroom_id')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-3 room" style="{{$quiz->room_id ?? 'display:none'}}">
                                <label class="form-label" for="room_id">Room</label>
                                <select name="room_id" id="room_id" class="select2 form-select">
                                    <option value="{{$quiz->room_id}}" selected>{{ $quiz->room_id ?$quiz->room->title :null}}</option>
                                </select>
                                @error('room_id')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                        ...
                        <div class="row mb-1">
                            <div class="mb-1 col-3 price">
                                ...
                                <input name="price" id="price" type="number" min="1" class="form-control" value="{{$quiz->price}}">
                                @error('price')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-3 timer_div">
                                ...
                                <input name="timer" id="timer" type="number" class="form-control" value="{{$quiz->timer}}">
                                @error('timer')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-3 Lock">
                                ...
                                <input name="lock_after" id="lock_after" type="number" class="form-control" value="{{$quiz->lock_after}}">
                                @error('lock_after')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mb-1 col-3 score_div">
                                ...
                                <input name="score" id="score" type="number" class="form-control" value="{{$quiz->score}}">
                                @error('score')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="mb-1 col-3">
                                <div class="form-check form-check-secondary form-switch inline-flex mb-1 col-6">
                                    <input type="checkbox" class="form-check-input" id="randomize_answer" name="randomize_answer" {{$quiz->randomize_answer ? "checked" :null}}>
                            ...
                            <div class="mb-1 col-3">
                                <div class="form-check form-check-secondary form-switch inline-flex mb-1  col-6">
                                    <input type="checkbox" class="form-check-input" id="randomize_question" name="randomize_question" {{$quiz->randomize_question ? "checked" :null}}>
                            ...
                            <div class="mb-1 col-3">
                                <div class="form-check form-check-secondary form-switch inline-flex mb-1  col-6">
                                    <input type="checkbox" class="form-check-input" id="show_answer" name="show_answer" {{$quiz->show_answer ? "checked" :null}}>
                            ...
                            <div class="mb-1 col-3">
                                <div class="form-check form-check-secondary form-switch inline-flex mb-1  col-6">
                                    <input type="checkbox" class="form-check-input" id="retake" name="retake" {{$quiz->retake ? "checked" :null}}>
                ...
                success: function (res) {
                    if(res.status){
                        ...
                        res.data.forEach((item)=>{
                            let items='';
                            if({{(string)$quiz->type}}=='1') {
                                if (item.id == {{$quiz->room_id??'null'}}) {
                                    items = 'selected'
                                }
                            }else{
                                if (item.id == {{($quiz->classroom_id)??'null'}}) {
                                    items = 'selected'
                                }
                            }
