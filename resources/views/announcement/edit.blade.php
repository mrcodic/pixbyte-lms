    ...
    <div class="wrapper-page-light f-height">
            ...
            <div class="uk-container uk-container-expand rm-expand">
                ...
                <div class="uk-flex uk-flex-middle uk-margin-small-left" uk-grid>
                    ...
                    <div class="page-header uk-margin-medium-top uk-margin-medium-bottom breadcrumb uk-width-3-4">
                        <h3 class="uk-margin-remove-bottom title-add">Add edit announcement</h3>
                    </div>
        ...
        <div class="uk-container uk-container-expand rm-expand uk-margin-medium-top uk-margin-left">
            ...
            <div class="add-announcement">
                <form action="{{ route('announcement.update',$announcement->id) }}" id="target" method="POST" enctype="multipart/form-data" class="announcement-form">
                    @csrf
                    @method('PATCH')
                    ...
                    <fieldset class="uk-fieldset add-new" uk-grid>
                        ...
                        <div class="uk-margin uk-width-1-1">
                            <input class="uk-input title @error('title')error-border @enderror" name="title" type="text" value="{{$announcement->name}}" placeholder="announcement title goes here....." autofocus>
                            @error('title')
                        ...
                        <div class="uk-margin uk-width-3-4@m uk-width-1-1@s">
                            ...
                            <textarea name="desc" id="desc" class="uk-textarea">{{$announcement->desc}}</textarea>
                            ...
                            <div class="uk-margin uk-width-1-4@m uk-width-1-1@s" id="classroom_id">
                                ...
                                <select multiple class="room_select uk-select @error('classroom_id')error-border @enderror" id="classroom_id" name="classroom_id[]">
                                    @foreach ( $classrooms as $classroom )
                                        <option value="{{$classroom->id}}"  @if(in_array($classroom->id,explode(',',$announcement->announcement_id))) selected @endif>{{ $classroom->title }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="uk-margin uk-width-1-1">
                            ...
                            <ul class="edit-room-material" id="parent">
                                @foreach($announcement->getmedia('file') as $key => $me)
    ...
    @section('script')
        ...
        <script>
            ...
            UIkit.upload('.js-upload', {
                ...
                url: '/uploadMaterialAnnouncement?_token={{csrf_token()}}',
                multiple: true,
                name:'files[]',
